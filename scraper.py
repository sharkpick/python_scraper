...
def timestamp():
	...
	ts = time.gmtime()
	raw_ts = "/home/will/scraper_data/raw/raw-" +time.strftime("%Y%m%d", ts)
	diff_ts = "/home/will/scraper_data/blacklists/bl-" +time.strftime("%Y%m%d", ts)
	raw_list = glob.glob('/home/will/scraper_data/raw/*')
